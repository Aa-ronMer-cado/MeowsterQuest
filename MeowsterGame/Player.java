public class Player {
    ...
    public void incrementTurn() {
        ...
        // Trigger special abilities every 3 turns
        if (turnCount % 3 == 0) {
    ...
    private void triggerSpecialAbility() {
        ...
        switch (color) {
            case ORANGE: // Radiant Burst - 300 damage
                System.out.println("Radiant energy explodes! (300 damage will be dealt)");
                break;
            case BLACK: // Shadow Speed - Extra turn
                System.out.println("Shadow Speed grants an extra turn!");
                break;
            case WHITE: // Healing Aura - Restore 200 HP
                heal(200);
                break;
            case TILAPIA: // Reflect Shield
                reflectActive = true;
